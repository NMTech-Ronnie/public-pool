...
import { StratumV1Client, WorkerStats } from './StratumV1Client';
...
describe('StratumV1Client', () => {
  ...
  beforeEach(async () => {
    ...
    newBlockEmitter.next({ blocks: 1 } as any);
    bitcoinRpcService.newBlock$ = newBlockEmitter.asObservable();

    stratumV1JobsService = new StratumV1JobsService(
      bitcoinRpcService,
      configService,
    );
