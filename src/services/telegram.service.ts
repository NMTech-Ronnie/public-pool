...
export class TelegramService implements OnModuleInit {
  ...
  constructor(
    ...
    // Load the Telegram client only when the bot is actually configured.
    // This avoids import-time side effects during tests and deployments that do not use Telegram.
